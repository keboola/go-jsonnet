...
type Notifier interface {
	// OnGeneratedValue notifies of each value generated by a native function.
	// Partial is true:
	//   - If the objects (values) were merged, and therefore only part of the value is from the native function.
	//   - In that case, partialValue and finalValue are different, otherwise they are the same.
	OnGeneratedValue(fnName string, args []interface{}, partial bool, partialValue, finalValue interface{}, steps []interface{})
}
